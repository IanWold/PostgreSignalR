...
* [Program.cs](/PostgreSignalR.Examples.CustomPayloadStrategy/Program.cs) shows how to register the custom strategy, and
* [CreatePayloadTable.sql](/PostgreSignalR.Examples.CustomTable/Migrations/1_CreatePayloadTable.sql) contains notes on the table implementation.