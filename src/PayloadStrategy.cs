...
public sealed class EventPayloadStrategy(IOptions<PostgresBackplaneOptions> options) : IPayloadStrategy
{
    /// <inheritdoc/>
...
/// </summary>
public sealed class TablePayloadStrategy : IPayloadStrategy
{
    ...
    public TablePayloadStrategy(IOptions<PostgresBackplaneOptions> backplaneOptions, IOptions<PayloadTableOptions> tableOptions)
    {
        ...
        if (tableOptions.Value.StorageMode == PayloadTableStorage.Auto)
        {
